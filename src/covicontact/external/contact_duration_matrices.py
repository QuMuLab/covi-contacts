...
def main(country=None, SECONDS_PER_MINUTE=None):
    ...
    return {
        ...
        'CONTACT_DURATION_NORMAL_MEAN_MATRIX': CONTACT_DURATION_NORMAL_MEAN_MATRIX,
        'CONTACT_DURATION_NORMAL_SIGMA_MATRIX': CONTACT_DURATION_NORMAL_SIGMA_MATRIX,
        'HOUSEHOLD_CONTACT_DURATION_NORMAL_MEAN_MATRIX': HOUSEHOLD_CONTACT_DURATION_NORMAL_MEAN_MATRIX,
        'HOUSEHOLD_CONTACT_DURATION_NORMAL_SIGMA_MATRIX': HOUSEHOLD_CONTACT_DURATION_NORMAL_SIGMA_MATRIX,
        'SCHOOL_CONTACT_DURATION_NORMAL_MEAN_MATRIX': SCHOOL_CONTACT_DURATION_NORMAL_MEAN_MATRIX,
        'SCHOOL_CONTACT_DURATION_NORMAL_SIGMA_MATRIX': SCHOOL_CONTACT_DURATION_NORMAL_SIGMA_MATRIX,
        'WORKPLACE_CONTACT_DURATION_NORMAL_MEAN_MATRIX': WORKPLACE_CONTACT_DURATION_NORMAL_MEAN_MATRIX,
        'WORKPLACE_CONTACT_DURATION_NORMAL_SIGMA_MATRIX': WORKPLACE_CONTACT_DURATION_NORMAL_SIGMA_MATRIX,
        'OTHER_CONTACT_DURATION_NORMAL_MEAN_MATRIX': OTHER_CONTACT_DURATION_NORMAL_MEAN_MATRIX,
        'OTHER_CONTACT_DURATION_NORMAL_SIGMA_MATRIX': OTHER_CONTACT_DURATION_NORMAL_SIGMA_MATRIX,
    }
